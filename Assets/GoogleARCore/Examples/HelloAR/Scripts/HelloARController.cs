        ...
        public void Update()
        {
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                ...
                else
                {
                    ...
                    {
                        prefab = null; //GameObjectPointPrefab;
                    }
                    else if (hit.Trackable is DetectedPlane)
                    {
                        ...
                        {
                            prefab = null; //GameObjectVerticalPlanePrefab;
                        }
                        else
                        {
                            if (loc1 == false)
                            {
                                prefab = location1; //GameObjectHorizontalPlanePrefab;
                                loc1 = true;
                            }
                            else if (loc1 == true)
                            {
                                prefab = location2;
                                loc2 = true; //~~~~~~~~~~~~~~~~~~~~~~~~~<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Add in a reference to both points being added in to the area.
                            }
                            else
                            {
                                prefab = null;
